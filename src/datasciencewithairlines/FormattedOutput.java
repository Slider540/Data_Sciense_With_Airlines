...
/**
 * Class that is used for validation testing and grading Pass answers to each
 * question into this Class The bundled JUnit test will use the output from this
 * Class to check answers Don't forget to call writeAnswers() at the end!
 *
 */
public class FormattedOutput {
     ...
     */
    public void writeAnswers(String dirName) {
        File out = new File(dirName, "answers.txt");
